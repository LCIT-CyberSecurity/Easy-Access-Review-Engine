...
def test_deleted_identity_requires_full_authoritative_import(tmp_path: Path) -> None:
    ...
    try:
        ...
        import_file_to_repository(repo, _ad_zip(tmp_path, "corp-ad", [], [], [], completeness="full"))
...
def _ad_zip(
    ...
    with ZipFile(archive, "w", ZIP_DEFLATED) as zf:
        ...
        zf.writestr("groups.csv", _csv(["SamAccountName", "Name", "SID", "GroupScope", "GroupCategory"], [
            {"SamAccountName": group, "Name": group, "SID": _sid(2101 + index), "GroupScope": "Global", "GroupCategory": "Security"}
